...
from news_oedigital.model import OeNews, WorldOil, CnpcNews, HartEnergy, OilFieldTech, \
    ...
    MarineExec,SplashOffshore,AmericanNews,OilGasIq
...
class OilGasIqPipeline:
    def process_item(self, item, spider):
        new_item = OilGasIq(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
...
class ShaiPgxPipeline:
    def process_item(self, item, spider):
        new_item = ShaiPgx(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                                preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                                content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                                categories=item.get('categories'))
...
class HydroProcessPipeline:
    def process_item(self, item, spider):
        new_item = HydroProcess(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                                  preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                                  content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                                  categories=item.get('categories'))
...
class PetroEconomistPipeline:
    def process_item(self, item, spider):
        new_item = PetroEconomist(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                         preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                         content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                         categories=item.get('categories'))
...
class GfBjxPipeline:
    def process_item(self, item, spider):
        new_item = GfBjx(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                         preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                         content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                         categories=item.get('categories'))
...
class FbBjxPipeline:
    def process_item(self, item, spider):
        new_item = FbBjx(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                             preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                             content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                             categories=item.get('categories'))
...
class SolarZoomPipeline:
    def process_item(self, item, spider):
        new_item = SolarZoom(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                              preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                              content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                              categories=item.get('categories'))
...
class EvWindPipeline:
    def process_item(self, item, spider):
        new_item = EvWind(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                           preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                           content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                           categories=item.get('categories'))
...
class EnergyTrendPipeline:
    def process_item(self, item, spider):
        new_item = EnergyTrend(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                                preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                                content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                                categories=item.get('categories'))
...
class PvMagazinePipeline:
    def process_item(self, item, spider):
        new_item = PvMagazine(title=item.get('title'), author=item.get('author'), pre_title=item.get('pre_title'), \
                               preview_img_link=item.get('preview_img_link'), pub_time=item.get('pub_time'), \
                               content=item.get('content'), crawl_time=item.get('crawl_time'), url=item.get('url'), \
                               categories=item.get('categories'))
